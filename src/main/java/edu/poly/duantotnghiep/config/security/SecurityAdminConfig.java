...
import edu.poly.duantotnghiep.enumtype.Roles;
import edu.poly.duantotnghiep.service.security.UserAdminService;
...
//    @Order(1)
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        String[] adminUrl = {"/admin/san-pham/add","/admin/san-pham/update/**","/admin/san-pham/delete/**"
                            ...
                            "/admin/mau-sac/**","/admin/thuong-hieu/**","/admin/thong-ke/**","/admin/nhan-xet/phe-duyet/**",
                            "/admin/chat-lieu/**"};
